 ...
 *
 * Mounted only while the dialog is up (see `./index`), so the link, the seal in
 * flight and anything that went wrong live exactly as long as it does.
 *
 ...
 */
export default function SendDialog({ entryId }: { entryId: string }) {
