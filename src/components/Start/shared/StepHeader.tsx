...
// Eyebrow, headline and lead paragraph — the top of every first-run screen's
// content, in the type the auth screens have always used (see the lock/setup
...
// The mascot above it belongs to the flow, not the screen (see Start), so it
// stays put while this changes under it.
