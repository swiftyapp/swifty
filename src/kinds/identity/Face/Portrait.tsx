...
export default function Portrait() {
  return (
    <div
      aria-hidden
      className="flex aspect-[3/4] w-[92px] flex-none items-end justify-center overflow-hidden rounded-[6px] border border-(--face-rule) bg-black/4 text-(--face-ink) @max-[420px]:w-[68px]"
    >
