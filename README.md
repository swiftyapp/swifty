...
passkey" reaches Rowel, which asks you in a dialog naming the site before it
answers. That needs KeePassXC-Browser 1.9 or newer, with its passkeys option
turned on in the extension's settings.
